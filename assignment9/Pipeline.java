...
public class Pipeline{
    ...
    public void startPipeline() {
        ...
        Filter filter2 = new Filter2(filter1,myQueue2); //must know of first 1, constructor takes arg
        Runnable runnable2 = filter2;
        Thread thread2 = new Thread(runnable2);
        thread2.start();

        //create third filter
        Filter filter3 = new Filter3(filter2, myQueue3); //must know of first 1, constructor takes arg
